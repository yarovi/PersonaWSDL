 ...
 * 2018-11-28T17:55:02.723-05:00
 * Generated source version: 3.1.16
 * 
 */
@WebServiceClient(name = "personaWS", 
                  wsdlLocation = "file:/E:/Repository/SpringWSDLl_lectura/src/main/resources/META-INF/wsdl/personaWS.wsdl",
                  targetNamespace = "http://webservice.yarovi.pe/services/personaws/ws") 
public class PersonaWS_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://webservice.yarovi.pe/services/personaws/ws", "personaWS");
    public final static QName PersonaWSDLSOAP = new QName("http://webservice.yarovi.pe/services/personaws/ws", "personaWSDLSOAP");
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/Repository/SpringWSDLl_lectura/src/main/resources/META-INF/wsdl/personaWS.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PersonaWS_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/E:/Repository/SpringWSDLl_lectura/src/main/resources/META-INF/wsdl/personaWS.wsdl");
        }
        WSDL_LOCATION = url;
    }
